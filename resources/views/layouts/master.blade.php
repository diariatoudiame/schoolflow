        ...
        <div class="header">
            <div class="header-left">
                <a href="{{ route('home') }}" class="logo">
                    <img src="{{ URL::to('assets/img/WhatsApp_Image_2024-09-22_at_18.24.13-removebg-preview.png') }}" alt="Logo" width="150" height="150">

                </a>
                <a href="{{ route('home') }}" class="logo logo-small">
                    <img src="{{ URL::to('assets/img/WhatsApp_Image_2024-09-22_at_18.24.13-removebg-preview.png') }}" alt="Logo" width="200" height="200">
